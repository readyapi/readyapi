...
Aún así, en ambas situaciones, es probable que **ReadyAPI** sea [aún más rápido](index.md#performance){.Internal-link target=_blank} que (o al menos comparable) a tu framework anterior.
