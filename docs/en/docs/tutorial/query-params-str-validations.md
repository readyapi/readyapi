...
Because `Annotated` can have more than one metadata annotation, you could now even use the same function with other tools, like <a href="https://typer.khulnasoft.com/" class="external-link" target="_blank">Typer</a>. 🚀
