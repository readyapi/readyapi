...
* ⬆️ Upgrade Starlette to `>=0.29.0,<0.33.0`, update docs and usage of templates with new Starlette arguments. PR [#10846](https://github.com/khulnasoft/readyapi/pull/10846) by [@khulnasoft](https://github.com/khulnasoft).
