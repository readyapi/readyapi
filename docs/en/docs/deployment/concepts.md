...
When you set up a remote server (a cloud server, a virtual machine, etc.) the simplest thing you can do is to use `readyapi run`, Uvicorn (or similar) manually, the same way you do when developing locally.
