...
If you need a 2 minute refresher of how to use Python types (even if you don't use ReadyAPI), check the short tutorial: [Python Types](../guides/python-types.md){.internal-link target=_blank}.
