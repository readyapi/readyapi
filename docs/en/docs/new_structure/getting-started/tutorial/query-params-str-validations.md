...
Remember I told you before that `Annotated` can be used to add metadata to your parameters in the [Python Types Intro](../guides/python-types.md){.internal-link target=_blank}?
