...
Чтобы добавить параметр к вашему _обработчику_, объявите его также, как вы объявляли параметры пути или параметры запроса:
...
Также она будет указана в документации по API внутри каждой _операции пути_, в которой используются:
