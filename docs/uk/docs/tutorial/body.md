...
Щоб додати модель даних до вашої _операції шляху_, оголосіть її так само, як ви оголосили параметри шляху та запиту:
...
А також використовуватимуться в API документації всередині кожної _операції шляху_, якій вони потрібні:
