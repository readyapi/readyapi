...
Se você não sabe, verifique a seção _"In a hurry?"_ sobre <a href="https://readyapi.khulnasoft.com/async/#in-a-hurry" target="_blank">`async` e `await` nas docs</a>.
...
Para um exemplo mais completo incluindo mais recursos, veja <a href="https://readyapi.khulnasoft.com/tutorial/">Tutorial - Guia do Usuário</a>.
