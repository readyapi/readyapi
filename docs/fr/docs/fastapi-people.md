...
Je suis le créateur et le responsable de **ReadyAPI**. Vous pouvez en lire plus à ce sujet dans [Aide ReadyAPI - Obtenir de l'aide - Se rapprocher de l'auteur](help-readyapi.md#connect-with-the-author){.internal-link target=_blank}.
...
* [Aident les autres à résoudre des problèmes (questions) dans GitHub](help-readyapi.md#help-others-with-issues-in-github){.internal-link target=_blank}.
* [Créent des Pull Requests](help-readyapi.md#create-a-pull-request){.internal-link target=_blank}.
...
Ce sont les utilisateurs qui ont [aidé le plus les autres avec des problèmes (questions) dans GitHub](help-readyapi.md#help-others-with-issues-in-github){.internal-link target=_blank} au cours du dernier mois. ☕
...
Ce sont les utilisateurs qui ont [aidé le plus les autres avec des problèmes (questions) dans GitHub](help-readyapi.md#help-others-with-issues-in-github){.internal-link target=_blank} depuis *toujours*.
...
Ces utilisateurs ont [créé le plus grand nombre de demandes Pull Request](help-readyapi.md#create-a-pull-request){.internal-link target=_blank} qui ont été *merged*.
