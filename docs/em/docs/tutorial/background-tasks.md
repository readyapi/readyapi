...
🥇, 🗄 `BackgroundTasks` &amp; 🔬 🔢 👆 _➡ 🛠️ 🔢_ ⏮️ 🆎 📄 `BackgroundTasks`:
...
⚙️ `BackgroundTasks` 👷 ⏮️ 🔗 💉 ⚙️, 👆 💪 📣 🔢 🆎 `BackgroundTasks` 💗 🎚: _➡ 🛠️ 🔢_, 🔗 (☑), 🎧-🔗, ♒️.
...
🕴 ⚙️ `BackgroundTasks` (&amp; 🚫 `BackgroundTask`), ⚫️ ⤴️ 💪 ⚙️ ⚫️ _➡ 🛠️ 🔢_ 🔢 &amp; ✔️ **ReadyAPI** 🍵 🎂 👆, 💖 🕐❔ ⚙️ `Request` 🎚 🔗.
