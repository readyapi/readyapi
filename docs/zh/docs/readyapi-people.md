...
* [帮助他人解决 GitHub 的 issues](help-readyapi.md#github_1){.internal-link target=_blank}。
...
上个月这些用户致力于 [帮助他人解决 GitHub 的 issues](help-readyapi.md#github_1){.internal-link target=_blank}。
...
这些用户一直以来致力于 [帮助他人解决 GitHub 的 issues](help-readyapi.md#github_1){.internal-link target=_blank}。
